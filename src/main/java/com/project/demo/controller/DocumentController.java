...
public class DocumentController {
    ...
    @PostMapping
    public ResponseEntity<MessageResource> createDocument(DocumentResource documentResource) {
        long newDocumentId = documentService.createDocument(documentResource);
    ...
    public ResponseEntity<MessageResource> updateDocument(@PathVariable(value = "documentId") long documentId, DocumentResource documentResource) {

    }


    @DeleteMapping(value = "/{documentId}")
    public ResponseEntity<MessageResource> deleteDocument(@PathVariable(value = "documentId") long documentId) {
